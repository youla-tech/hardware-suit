/*
 * @Author: eamiear
 * @Date: 2021-02-02 14:40:32
 * @Last Modified by: eamiear
 * @Last Modified time: 2021-02-03 17:08:28
 */
...
const SensorDetectStatusMap:any = {
  [SensorDetectStatusEnum.NONE]: '关闭',
  [SensorDetectStatusEnum.ON]: '打开'
}
const SensorDetectAwakeStatusMap: any = {
  [SensorDetectStatusEnum.NONE_AWAKE]: '无唤醒',
  [SensorDetectStatusEnum.AWAKE]: '唤醒'
}
const SensorDetectKeyStatusMap: any = {
  [SensorDetectStatusEnum.NONE_KEY]: '无按键',
  [SensorDetectStatusEnum.KEY]: '按键'
}

export class SensorDoorEquip extends BaseEquip {
